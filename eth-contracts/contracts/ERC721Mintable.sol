...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "Msg Sender is not contract owner");
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "Address should be an External Account Address.");
        _owner = newOwner;
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(_newownerof != to, "Token exists already.");
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require((_newownerof  == msg.sender) || (isApprovedForAll(_newownerof, msg.sender)), "Condition didn't not meet");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        require(ownerOf(tokenId) == from, "owner of the token is required");
        // TODO: require token is being transfered to valid address
        require(to != address(0), "is not a valid address");
        // TODO: clear approval
...
contract BatisERC721Token is ERC721Metadata("BatisToken", "BST", "https://s3-us-west-2.amazonaws.com/udacity-blockchain/capstone/") {
